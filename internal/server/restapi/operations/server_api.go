...
func NewServerAPI(spec *loads.Document) *ServerAPI {
	return &ServerAPI{
		...
		NotifyNotifyEmailHandler: notify.NotifyEmailHandlerFunc(func(params notify.NotifyEmailParams, principal *models.Principal) middleware.Responder {
			return middleware.NotImplemented("operation notify.NotifyEmail has not yet been implemented")
		}),
		NotifyNotifySMSHandler: notify.NotifySMSHandlerFunc(func(params notify.NotifySMSParams, principal *models.Principal) middleware.Responder {
...
/*ServerAPI Post API for Racoon Media Server Project */
type ServerAPI struct {
	...
	// NotifyNotifyEmailHandler sets the operation handler for the notify email operation
	NotifyNotifyEmailHandler notify.NotifyEmailHandler
	// NotifyNotifySMSHandler sets the operation handler for the notify s m s operation
	NotifyNotifySMSHandler notify.NotifySMSHandler
...
func (o *ServerAPI) Validate() error {
	...
	if o.NotifyNotifyEmailHandler == nil {
		unregistered = append(unregistered, "notify.NotifyEmailHandler")
	}
	if o.NotifyNotifySMSHandler == nil {
		unregistered = append(unregistered, "notify.NotifySMSHandler")
	}
...
func (o *ServerAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/notify/email"] = notify.NewNotifyEmail(o.context, o.NotifyNotifyEmailHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/notify/sms"] = notify.NewNotifySMS(o.context, o.NotifyNotifySMSHandler)
}
